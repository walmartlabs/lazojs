define(['l!base', 'l!serviceProxy'], function (Base, ServiceProxy) {
    ...
    var Syncher = Base.extend({
        ...
        setHttpStatusCode: function (statusCode) {
            ...
            this.proxy.ctx.response.statusCode = statusCode;
            return this;
        },
        ...
        getHttpStatusCode: function () {
            ...
            return this.proxy.ctx.response.statusCode || 200;
        },
        ...
        addHttpHeader: function (name, value, options) {
            ...
            this.proxy.ctx.response.httpHeaders.push({ name: name, value: value, options: options || null });
            return this;
        },
        ...
        getHttpHeaders: function () {
            ...
            return this.proxy.ctx.response.httpHeaders || [];
        },
        ...
        addHttpVaryParam: function (varyParam) {
            ...
            this.proxy.ctx.response.varyParams.push(varyParam);
            return this;
        },
        ...
        getHttpVaryParams: function () {
            ...
            return this.proxy.ctx.response.varyParams || [];
        }
